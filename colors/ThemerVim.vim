  ...
  let s:guishade1 = "#dddddd"
  let s:guishade2 = "#dddddd"
  let s:guishade3 = "#dddddd"
  let s:guishade4 = "#dddddd"
  let s:guishade5 = "#dddddd"
  let s:guishade6 = "#dddddd"
  ...
  let s:ctermshade3 = 253
  let s:ctermshade4 = 253
  let s:ctermshade5 = 253
